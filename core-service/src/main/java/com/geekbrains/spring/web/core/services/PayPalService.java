...
public class PayPalService {
    ...
    public OrderRequest createOrderRequest(Long orderId) {
        com.geekbrains.spring.web.core.entities.Order order = orderService.findByIdAndStatus(orderId, OrderStatus.NEW).orElseThrow(() -> new ResourceNotFoundException("Заказ не найден"));
